        ...
        <div>
          <div className="gallery">
            <div className="gallery-main">
              ...
              {car.badge && <span className="gallery-badge">{car.badge}</span>}
              <button className={`gallery-save ${saved ? 'saved' : ''}`} onClick={() => toggleSave(car.id)}>
          ...
          <div className="listing-info">
            ...
            <div className="listing-specs">
              <div className="listing-spec"><svg viewBox="0 0 24 24"><path d="M12 20C16.4 20 20 16.4 20 12S16.4 4 12 4 4 7.6 4 12 7.6 20 12 20M12 2C17.5 2 22 6.5 22 12S17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M12.5 7V12.25L17 14.92L16.25 16.15L11 13V7H12.5Z"/></svg>{car.mileage.toLocaleString()} km</div>
              <div className="listing-spec"><svg viewBox="0 0 24 24"><path d="M19.77 7.23L19.78 7.22L16.06 3.5L15 4.56L17.11 6.67C16.17 7.03 15.5 7.93 15.5 9C15.5 10.38 16.62 11.5 18 11.5C18.36 11.5 18.69 11.42 19 11.29V18.5C19 19.05 18.55 19.5 18 19.5S17 19.05 17 18.5V14C17 12.9 16.1 12 15 12H14V5C14 3.9 13.1 3 12 3H6C4.9 3 4 3.9 4 5V21H14V13.5H15.5V18.5C15.5 19.88 16.62 21 18 21S20.5 19.88 20.5 18.5V9C20.5 8.31 20.22 7.68 19.77 7.23M12 10H6V5H12V10Z"/></svg>{car.fuel}</div>
            ...
            <div className="listing-desc">{car.desc}</div>
