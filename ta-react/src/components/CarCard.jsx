...
export default function CarCard({ car, delay = 0 }) {
  ...
  return (
    <div className="car-card" style={{ animationDelay: `${delay}s` }} onClick={() => navigate(`/listing/${car.id}`)}>
      <div className="car-card-img">
        ...
        {car.badge && <span className={`card-badge ${car.badge === 'New' ? 'new' : ''}`}>{car.badge}</span>}
        <button className={`card-save ${saved ? 'saved' : ''}`} onClick={e => { e.stopPropagation(); toggleSave(car.id); }}>
      ...
      <div className="car-card-body">
        ...
        <div className="card-specs">
          <span className="card-spec"><svg viewBox="0 0 24 24"><path d="M12 20C16.4 20 20 16.4 20 12S16.4 4 12 4 4 7.6 4 12 7.6 20 12 20M12 2C17.5 2 22 6.5 22 12S17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M12.5 7V12.25L17 14.92L16.25 16.15L11 13V7H12.5Z"/></svg>{car.mileage.toLocaleString()} km</span>
        ...
        <div className="card-footer">
          <div>
            ...
            <div className="card-price">GHS {car.price.toLocaleString()}</div>
          </div>
